...
func DeepRecursionQuery(client *http.Client, Endpoint string) {
	data, _ := utils.ReadFile("templates/graphql/deeprecursionquery.json")
	...
	fmt.Println("")
	fmt.Println(color.Green + "[*] Sending the Deep Recursion Query..." + color.Reset)
