...
func AliasedBasedQuery(client *http.Client, Endpoint string) {
	data, _ := utils.ReadFile("templates/graphql/aliasedbasedquery.json")
	...
	fmt.Println("")
	fmt.Println(color.Green + "[*] Sending the Aliased Based Query..." + color.Reset)
