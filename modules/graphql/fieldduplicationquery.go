...
func FieldDuplicationQuery(client *http.Client, Endpoint string) {
	data, _ := utils.ReadFile("templates/graphql/fieldduplicationquery.json")
	...
	fmt.Println("")
	fmt.Println(color.Green + "[*] Sending the field duplication query..." + color.Reset)
